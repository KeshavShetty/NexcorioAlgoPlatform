...
public class G3AutoIndexFollowerRollingSpikeAversionAlgoThread extends G3BaseClass implements Runnable{
	...
	public G3AutoIndexFollowerRollingSpikeAversionAlgoThread(Long napAlgoId, String backTestDateStr) {
		super(napAlgoId);
